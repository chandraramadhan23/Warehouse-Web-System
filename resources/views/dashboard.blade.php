...
<script>
    // Chart Total Produk
    function chartTotalProduk() {
        const ctx = document.getElementById('totalproduk');
        const data = {
            labels: [
    ...
    // Chart Total Laporan
    function chartTotalLaporan() {
        const ctx = document.getElementById('totallaporan');
        const data = {
            labels: [
            ...
            datasets: [{
                label: 'Total Laporan',
                data: [{{ $totalLaporanMasuk }}, {{ $totalLaporanKeluar }}],
                backgroundColor: [
                    'rgba(153, 102, 255, 0.2)',
                    'rgba(201, 203, 207, 0.2)',
                ],
